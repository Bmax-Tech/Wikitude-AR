...
- (BOOL)startRenderingWithTargetFrameRate:(NSInteger)targetFrameRate renderingAPIs:(NSOrderedSet<WTRenderingAPI> *)renderingAPIs usingBlock:(WTRenderingBlock)renderBlock error:(NSError * __autoreleasing *)error;

- (void)pauseRendering:(BOOL)keepContextAlive;

- (void)generateImageFromNextFrame;

- (NSOrderedSet *)renderingAPIs;
